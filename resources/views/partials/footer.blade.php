...
<footer id="footer" class="bg-color-sinergi border-top-0" style="margin-top: {{ $marginTop }}">
        ...
        <div class="container pt-1">
            <div class="row py-5 text-center text-lg-start">
                <div class="col-sm-12 col-lg-4">
                    ...
                    <p class="text-pt-footer-small">Substation and Electrical Services, Electric Vehicle Charger and
                        Energy & Environment Management</p>
                </div>
                    ...
                    <div class="feature-box feature-box-style-2 float-lg-start d-block d-lg-flex mb-4 mb-lg-3">
                        ...
                        <div class="feature-box-info ps-1">
                            ...
                            <a href="tel:02122352886"
                                class="text-color-light font-weight-semibold text-decoration-none">021-22352886</a>
                        </div>
                    </div>
                    <div class="feature-box feature-box-style-2 float-lg-start d-block d-lg-flex mb-4 mb-lg-3">
                        <div class="feature-box-icon">
                        ...
                        <div class="feature-box-info ps-1">
                            ...
                            <a href="mailto:sinergi.rodika@gmail.com"
                                class="text-color-light font-weight-semibold text-decoration-none">sinergi.rodika@gmail.com</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="footer-copyright footer-copyright-style-2">
        <div class="container py-1">
            <div class="row">
                <div
                    class="col-lg-12 d-flex align-items-center justify-content-center justify-content-lg-start mb-4 mb-lg-0 pt-4 pt-lg-0">
