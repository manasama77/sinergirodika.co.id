            ...
            <div class="col-lg-6">
                ...
                <form id="form" class="contact-form" action="{{ route('send-mail') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-6">
                            <label class="form-label mb-1 text-2">WhatsApp</label>
            ...
            <div class="col-lg-6">
                ...
                <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="0">
                    ...
                    <ul class="list list-icons list-icons-style-2 mt-2">
                        <li><i class="fas fa-map-marker-alt top-6"></i> <strong class="text-dark">Address:</strong> Jl.
                        ...
                        <li><i class="fas fa-phone top-6"></i> <strong class="text-dark">Phone:</strong> <a
                                href="tel:02122352886">021 22352886</a></li>
                        <li><i class="fab fa-whatsapp top-6"></i> <strong class="text-dark">Whatsapp:</strong> <a
                                href="https://wa.me/628111923762">08111923762</a>
                        </li>
                ...
                <p class="lead mb-0 text-4 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="0">
