        ...
        <div class="row pt-2">
            ...
            <div class="col-lg-9">
                ...
                <div id="energy-monitoring-for-utilities" class="my-3">
                    <h3 class="font-weight-bold text-2 mb-2">Public Utilities Monitoring (Electricity, Gas, Water)</h3>
                    <img class="img-fluid col-12 col-md-6 offset-md-3 mb-1" src="{{ asset('img/Utility-Scheme.png') }}"
                        alt="Utility Scheme">
                    <p class="text-2 text-dark mb-1">Electricity, gas and water meters with built-in LoRA modem or connect
                        to
                ...
                <div id="street-lighting" class="my-3">
                    <h3 class="font-weight-bold text-2 mb-2">Street Lighting</h3>

                    <div class="d-flex justify-content-center gap-1">
                        <div>
                            <img class="img-fluid m-3" src="{{ asset('img/Streetlamp-Scheme.png') }}" alt="Utility Scheme"
                                style="height: 240px;">
                        </div>
                        <div class="flex-row gap-1">
                            <div class="text-center">
                                <img class="img-fluid" src="{{ asset('img/Smart-Lamp.png') }}" alt="Smart Lamp"
                                    style="height: 65px;">
                                <p class="font-weight-bold text-1 mb-1 text-dark">Smart Lamp</p>
                            </div>
                            <div class="text-center">
                                <img class="img-fluid" src="{{ asset('img/Nema-Controller.png') }}" alt="Nema Controller"
                                    style="height: 65px;">
                                <p class="font-weight-bold text-1 mb-1 text-dark">Nema Controller</p>
                            </div>
                            <div class="text-center">
                                <img class="img-fluid" src="{{ asset('img/Internal-Single-Light-Controller.png') }}"
                                    alt="Internal Single Light Controller" style="height: 65px;">
                                <p class="font-weight-bold text-1 mb-1 text-dark">Internal Single Light Controller</p>
                            </div>
                        </div>
                    </div>

                    <p class="text-2 text-dark mb-1">Complete solution for energy billing, scheduling timer and ON/OFF,
                        light intensity and
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-4">
                            ...
                            <p class="text-2 text-dark mb-1">To know the current condition of the lamps by sending data
                                parameters via application
                                online 24/7 </p>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <h3 class="font-weight-bold text-2 mb-2">Controlling</h3>
                            <p class="text-2 text-dark mb-1">Done by remote to reach efficiency and speed of service</p>
                        </div>
                        <div class="col-sm-12 col-md-4">
                            <h3 class="font-weight-bold text-2 mb-2">Good for Money</h3>
                            <p class="text-2 text-dark mb-1">By performing efficient and man-free operation to save more
                                money in Energy
                ...
                <div id="cctv" class="my-3">
                    <h3 class="font-weight-bold text-2 mb-2">CCTV</h3>
                        ...
                        <div class="flex-row gap-2 justify-content-around">
                            <div class="text-center">
                                <img class="img-fluid" src="{{ asset('img/Outdoor-IP-Camera.png') }}"
                                    alt="Outdoor IP Camera" style="height: 65px;">
                                <p class="font-weight-bold text-1 mb-1 text-dark">Outdoor IP Camera</p>
                            </div>
                            <div class="text-center">
                                <img class="img-fluid" src="{{ asset('img/Indoor-IP-Camera.png') }}" alt="Indoor IP Camera"
                                    style="height: 65px;">
                                <p class="font-weight-bold text-1 mb-1 text-dark">Indoor IP Camera</p>
                            </div>
                            <div class="text-center">
                                <img class="img-fluid" src="{{ asset('img/Network-Video-Recorder.jpg') }}"
                                    alt="Network Video Recorder" style="height: 30px;">
                                <p class="font-weight-bold text-1 mb-1 text-dark">Network Video Recorder</p>
                            </div>
                        </div>
                    </div>
                ...
                <div id="water-flood-monitoring" class="my-3">
                    <h3 class="font-weight-bold text-2 mb-2">Water/ Flood Monitoring</h3>
                    <div class="col-12 col-md-6 offset-md-3 mb-1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-4">
                            ...
                            <h3 class="font-weight-bold text-1 mb-1 text-dark text-center">ULTRASONIC SILT LEVEL SENSOR
                            </h3>
                            <p class="text-2 text-dark mb-1">
